...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c",
        "name": "annotatedyaml.reference",
        "sources": [
            "src/annotatedyaml/reference.py"
        ]
    },
    "module_name": "annotatedyaml.reference"
}
END: Cython Metadata */
...
#define __PYX_HAVE__annotatedyaml__reference
#define __PYX_HAVE_API__annotatedyaml__reference
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
#define __Pyx_MODULE_NAME "annotatedyaml.reference"
extern int __pyx_module_is_main_annotatedyaml__reference;
int __pyx_module_is_main_annotatedyaml__reference = 0;

/* Implementation of "annotatedyaml.reference" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_13annotatedyaml_9reference__add_reference_to_node_class(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_obj, PyObject *__pyx_v_loader, PyObject *__pyx_v_node); /* proto */
...
#define __pyx_kp_u_NodeDictClass_NodeListClass_Node __pyx_string_tab[2]
#define __pyx_kp_u_annotatedyaml_loader __pyx_string_tab[3]
#define __pyx_kp_u_annotatedyaml_objects __pyx_string_tab[4]
#define __pyx_kp_u_src_annotatedyaml_reference_py __pyx_string_tab[5]
#define __pyx_kp_u_yaml_nodes_Node __pyx_string_tab[6]
#define __pyx_n_u_LoaderType __pyx_string_tab[7]
#define __pyx_n_u_NodeDictClass __pyx_string_tab[8]
#define __pyx_n_u_NodeListClass __pyx_string_tab[9]
#define __pyx_n_u_NodeStrClass __pyx_string_tab[10]
#define __pyx_n_u_TYPE_CHECKING __pyx_string_tab[11]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[12]
#define __pyx_n_u_annotate __pyx_string_tab[13]
#define __pyx_n_u_config_file __pyx_string_tab[14]
#define __pyx_n_u_func __pyx_string_tab[15]
#define __pyx_n_u_line_2 __pyx_string_tab[16]
...
#define __pyx_n_u_add_reference_to_node_class __pyx_string_tab[23]
#define __pyx_n_u_is_coroutine __pyx_string_tab[24]
#define __pyx_n_u_annotatedyaml_reference __pyx_string_tab[25]
#define __pyx_n_u_asyncio_coroutines __pyx_string_tab[26]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[27]
#define __pyx_n_u_get_name __pyx_string_tab[28]
#define __pyx_n_u_items __pyx_string_tab[29]
#define __pyx_n_u_line __pyx_string_tab[30]
#define __pyx_n_u_loader __pyx_string_tab[31]
#define __pyx_n_u_node __pyx_string_tab[32]
#define __pyx_n_u_obj __pyx_string_tab[33]
#define __pyx_n_u_objects __pyx_string_tab[34]
#define __pyx_n_u_pop __pyx_string_tab[35]
#define __pyx_n_u_setdefault __pyx_string_tab[36]
#define __pyx_n_u_start_mark __pyx_string_tab[37]
#define __pyx_n_u_typing __pyx_string_tab[38]
#define __pyx_n_u_values __pyx_string_tab[39]
#define __pyx_n_u_yaml __pyx_string_tab[40]
#define __pyx_kp_b_PyObject_PyObject_PyObject_PyObj __pyx_string_tab[41]
#define __pyx_kp_b_iso88591_3d_wa_z_r __pyx_string_tab[42]
...
static PyObject *__pyx_f_13annotatedyaml_9reference__add_reference_to_node_class(PyObject *__pyx_v_obj, PyObject *__pyx_v_loader, PyObject *__pyx_v_node, CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyObject *__pyx_v_start_mark = NULL;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_add_reference_to_node_class", 0);

  /* "annotatedyaml/reference.py":19
 * ) -> None:
...
*/
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_loader, __pyx_mstate_global->__pyx_n_u_get_name); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_PyObject_SetAttrStr(__pyx_v_obj, __pyx_mstate_global->__pyx_n_u_config_file, __pyx_t_1) < (0)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "annotatedyaml/reference.py":20
 *     """Add file reference information to a node class object."""
 *     obj.__config_file__ = loader.get_name
 *     if (start_mark := node.start_mark) is not None:             # <<<<<<<<<<<<<<
 *         obj.__line__ = start_mark.line + 1
*/
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_node, __pyx_mstate_global->__pyx_n_u_start_mark); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  if (__pyx_t_2) {
    ...
    /* "annotatedyaml/reference.py":21
 *     obj.__config_file__ = loader.get_name
 *     if (start_mark := node.start_mark) is not None:
 *         obj.__line__ = start_mark.line + 1             # <<<<<<<<<<<<<<
*/
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_start_mark, __pyx_mstate_global->__pyx_n_u_line); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 21, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    ...
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    if (__Pyx_PyObject_SetAttrStr(__pyx_v_obj, __pyx_mstate_global->__pyx_n_u_line_2, __pyx_t_3) < (0)) __PYX_ERR(0, 21, __pyx_L1_error)
...
*/
  ...
  __Pyx_AddTraceback("annotatedyaml.reference._add_reference_to_node_class", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_start_mark);
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_add_reference_to_node_class (wrapper)", 0);
  #if !CYTHON_VECTORCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_obj,&__pyx_mstate_global->__pyx_n_u_loader,&__pyx_mstate_global->__pyx_n_u_node,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "_add_reference_to_node_class", 0) < (0)) __PYX_ERR(0, 13, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("_add_reference_to_node_class", 1, 3, 3, i); __PYX_ERR(0, 13, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("_add_reference_to_node_class", 1, 3, 3, __pyx_nargs); __PYX_ERR(0, 13, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __pyx_r = __pyx_pf_13annotatedyaml_9reference__add_reference_to_node_class(__pyx_self, __pyx_v_obj, __pyx_v_loader, __pyx_v_node);
...
static PyObject *__pyx_pf_13annotatedyaml_9reference__add_reference_to_node_class(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_obj, PyObject *__pyx_v_loader, PyObject *__pyx_v_node) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("_add_reference_to_node_class", 0);
  __pyx_t_1 = __pyx_f_13annotatedyaml_9reference__add_reference_to_node_class(__pyx_v_obj, __pyx_v_loader, __pyx_v_node, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  {
    PyObject *__pyx_temp;
    {
...
static int __Pyx_modinit_Function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  /*--- Function export code ---*/
  {
    ...
    #endif
    const char * __pyx_export_name = __pyx_export_signature + 72;
    void (*const __pyx_export_pointers[])(void) = {(void (*)(void))&__pyx_f_13annotatedyaml_9reference__add_reference_to_node_class, (void (*)(void)) NULL};
...
__Pyx_RefNannySetupContext("PyInit_reference", 0);
  ...
  if (__pyx_module_is_main_annotatedyaml__reference) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "annotatedyaml.reference")) {
      if (unlikely((PyDict_SetItemString(modules, "annotatedyaml.reference", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_yaml, __pyx_t_2) < (0)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_NodeDictClass,__pyx_mstate_global->__pyx_n_u_NodeListClass,__pyx_mstate_global->__pyx_n_u_NodeStrClass};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_objects, __pyx_imported_names, 3, __pyx_mstate_global->__pyx_kp_u_annotatedyaml_objects, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
...
*/
    {
      ...
      __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_loader, __pyx_imported_names, 1, __pyx_mstate_global->__pyx_kp_u_annotatedyaml_loader, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
    }
    __pyx_t_2 = __pyx_t_1;
    __Pyx_GOTREF(__pyx_t_2);
    {
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_obj, __pyx_mstate_global->__pyx_kp_u_NodeDictClass_NodeListClass_Node) < (0)) __PYX_ERR(0, 13, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_loader, __pyx_mstate_global->__pyx_n_u_LoaderType) < (0)) __PYX_ERR(0, 13, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_node, __pyx_mstate_global->__pyx_kp_u_yaml_nodes_Node) < (0)) __PYX_ERR(0, 13, __pyx_L1_error)
  __pyx_t_4 = __Pyx_CyFunction_New(&__pyx_mdef_13annotatedyaml_9reference_1_add_reference_to_node_class, 0, __pyx_mstate_global->__pyx_n_u_add_reference_to_node_class, NULL, __pyx_mstate_global->__pyx_n_u_annotatedyaml_reference, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_add_reference_to_node_class, __pyx_t_4) < (0)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init annotatedyaml.reference", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init annotatedyaml.reference");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } str_length_index[] = {{1},{1},{44},{20},{21},{30},{15},{10},{13},{13},{12},{13},{20},{12},{15},{8},{8},{8},{10},{8},{12},{12},{8},{28},{13},{23},{18},{18},{8},{5},{4},{6},{4},{3},{7},{3},{10},{10},{6},{6},{4}};
    const struct { const unsigned int length: 7; } bytes_length_index[] = {{100},{51}};
    #ifndef CYTHON_COMPRESS_STRINGS
      #define CYTHON_COMPRESS_STRINGS 0
    #endif
    #if (CYTHON_COMPRESS_STRINGS) == 1 /* compression: zlib (379 bytes) */
static const char cstring[] = "x\332}P\261\216\0231\020\275Hp\204\344\256\240\241\240\332\n\001\202Mq\355IW\204\010\320\241\020A\032*kb\317\346|\331\265\215={d\321\025\224)S\246\3342\237C\271\237\301\047`;$\307\026\234%k\346\3313\363\336\274\364b\254\005\276\225\234\20698\227\334&\001\177\224\256\205\277\220\215\020\224\322\004\204\242\202\"Os\r\002m\373M\317\256\221\223s\226\017Z\037\003\213\031ZT\034SS\305J\345\347\2724\262\3059\323\312`KKK\310\277*\246_\047#6|?\032^~\030\277clR-\375\rml\214K\372\214\031c{n\346\017\327*\223s\226\311<\302\254T<\304\\\252\210\013\220*F-\312]\205\202\"F\343\007s02\344\337J\310\367\357\204\216|\000!\330a+F\232\205\215\030\017\n\231t\236\326\352\222<I\333\240C\007\270Jq\251\323C\235\343Q\222WC\0268\316\200/\346HQ\215$,\\\370\335Y\036\210\274\321\177\2756\3328$\201\031\22499\002K~\047\273\240\312H5\277\201\274D\027\230\047\325\247X\237\274zq\227\276N\376\227KE\311\316\002\267\220\206\t\351\014\020\277zyt\337\336?;\315\343^sr\332\364\372\277\217\217\036v\177=z\266y^w\232\007\335U\177}\266\026\2337\365\367-4\335\376\352|\375\243~Z\333\355\223?z\351\367\211";
    PyObject *data = __Pyx_DecompressString(cstring, 379, 1);
    ...
    #endif
    #else /* compression: none (641 bytes) */
static const char bytes[] = ".?NodeDictClass | NodeListClass | NodeStrClassannotatedyaml.loaderannotatedyaml.objectssrc/annotatedyaml/reference.pyyaml.nodes.NodeLoaderTypeNodeDictClassNodeListClassNodeStrClassTYPE_CHECKING__Pyx_PyDict_NextRef__annotate____config_file____func____line____main____module____name____pyx_capi____qualname____test___add_reference_to_node_class_is_coroutineannotatedyaml.referenceasyncio.coroutinescline_in_tracebackget_nameitemslineloadernodeobjobjectspopsetdefaultstart_marktypingvaluesyamlPyObject *(PyObject *, PyObject *, PyObject *, int __pyx_skip_dispatch)\000_add_reference_to_node_class\200\001\330\t\n\330\014\r\330\n\013\360\006\000\005\010\320\007\032\230&\240\001\330\004\010\210\013\2203\220d\230-\240w\250a\330\010\013\210<\220z\240\026\240r\250\021";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_obj, __pyx_mstate->__pyx_n_u_loader, __pyx_mstate->__pyx_n_u_node};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_src_annotatedyaml_reference_py, __pyx_mstate->__pyx_n_u_add_reference_to_node_class, __pyx_mstate->__pyx_kp_b_iso88591_3d_wa_z_r, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
